      ...
      <div className="w-full max-w-md">
        ...
        <Card className="border-0 shadow-2xl rounded-3xl bg-white/80 backdrop-blur-sm">
          ...
          <CardContent className="space-y-6">
            ...
            <Button
              ...
              disabled={isLoading}
              className="w-full h-12 bg-white hover:bg-gray-50 text-slate-700 border border-slate-200 rounded-2xl font-medium shadow-sm hover:shadow-md transition-all duration-200"
            >
              <Image
            ...
            <form onSubmit={handleEmailLogin} className="space-y-4">
              ...
              <Button
                type="submit"
                disabled={isLoading}
                className="w-full h-12 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white rounded-2xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300"
              >
                {isLoading ? (
        ...
        <div className="text-center mt-6">
          <p className="text-slate-500 text-sm">
            ¿No tienes cuenta?{" "}
            <button className="text-purple-600 hover:text-purple-700 font-medium">Regístrate aquí</button>
          </p>
        </div>
      </div>
    </div>
